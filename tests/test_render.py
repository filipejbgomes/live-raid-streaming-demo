...
class RenderTests(unittest.TestCase):
    ...
    def test_default_storage_and_local_images(self):
        s=self.render('k8s/demo/verifier.yaml');self.assertNotIn('storageClassName',s);self.assertIn('raid-verifier:local',s)
    def test_registry_upgrade_and_pull_secret(self):
        ...
        self.assertIn('registry.example/team/raid-score-engine-v1:test-42',s);self.assertIn('"name": "pull"',s);self.assertNotIn('file://',s)
